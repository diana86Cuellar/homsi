...
<?php
	...
	$query = "SELECT * from tb_accidente";
	...
	$pdf->Cell(50,6,'CODIGO ACCIDENTE',1,0,'C',1);
	...
	{
		$pdf->Cell(50,6,utf8_decode($row['ID_Acci']),1,0,'C');
		$pdf->Cell(50,6,utf8_decode($row['Acc_Fecha']),1,0,'C');
		$pdf->Cell(50,6,utf8_decode($row['Acc_Desc']),1,1,'C');
	}
	$pdf->Output();
?>